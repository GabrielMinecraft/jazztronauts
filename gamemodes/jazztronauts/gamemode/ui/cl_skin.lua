...
SKIN.bg_color					= Color( 101, 0, 105, 255 )
SKIN.bg_color_sleep				= Color( 70, 0, 70, 255 )
SKIN.bg_color_dark				= Color( 55, 0, 61, 255 )
SKIN.bg_color_bright			= Color( 220, 0, 220, 255 )
SKIN.frame_border				= Color( 50, 0, 50, 255 )

SKIN.fontFrame					= "DermaDefault"

SKIN.control_color				= Color( 120, 0, 120, 255 )
SKIN.control_color_highlight	= Color( 150, 0, 150, 255 )
SKIN.control_color_active		= Color( 110, 0, 250, 255 )
SKIN.control_color_bright		= Color( 255, 0, 100, 255 )
SKIN.control_color_dark			= Color( 100, 0, 100, 255 )

SKIN.bg_alt1					= Color( 50, 0, 50, 255 )
SKIN.bg_alt2					= Color( 55, 0, 55, 255 )
...
function SKIN:PaintPanel( panel, w, h )
	...
	--surface.SetDrawColor(140,0,255)
...
function SKIN:PaintTab( panel, w, h )
	...
	draw.RoundedBox(4, 0, 0, w, h, Color(100,0,255))
...
function SKIN:PaintVScrollBar( panel, w, h )
	...
	draw.RoundedBox(4, 0, 0, w, h, Color(190,120,10))
...
derma.DefineSkin( "Jazz", "Its a skin", SKIN )
